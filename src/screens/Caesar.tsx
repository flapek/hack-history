...
import { translation } from '../features/caesar';
import { getHints } from '../features/caesar/caesarSlice';
...
export default function Caesar() {
  ...
  let decryptedUsername = Cipher.encrypt(CipherType.CEASAR, username);
