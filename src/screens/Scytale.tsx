...
import { translation } from '../features/scytale';
import { getHints } from '../features/scytale/scytaleSlice';
...
export default function Scytale() {
  ...
  let decryptedUsername = Cipher.encrypt(CipherType.SCYTALE, username);
