...
import { translation } from '../features/jefferson';
import { getHints } from '../features/jefferson/jeffersonSlice';
...
export default function Jefferson() {
  ...
  let decryptedUsername = Cipher.encrypt(CipherType.JEFFERSON, username);
