...
import { translation } from '../features/vigenere';
import { getHints } from '../features/vigenere/vigenereSlice';
...
export default function Vigenere() {
  ...
  let decryptedUsername = Cipher.encrypt(CipherType.VIGENERE, username);
